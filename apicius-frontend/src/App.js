...
import RecipeReviewCreate from './components/RecipeReviewCreate';
import RecipeReviewEdit from './components/RecipeReviewEdit';
        ...
        <Router>
            <Routes>
                ...
                <Route element={<MasterPage />}>
                    ...
                    <Route path="/recipe-review/create" element={<ProtectedRoute user={user} loading={loading}><RecipeReviewCreate /></ProtectedRoute>} />
                    <Route path="/recipe-review/edit" element={<ProtectedRoute user={user} loading={loading}><RecipeReviewEdit /></ProtectedRoute>} />
                </Route>
            </Routes>
