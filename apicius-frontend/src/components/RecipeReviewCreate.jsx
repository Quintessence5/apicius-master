...
const RecipeReviewCreate = () => {
    ...
    // Initialize ingredients from extracted recipe
    useEffect(() => {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await axios.post('/api/transcripts/save-recipe', {
                generatedRecipe: { ...editedRecipe, servings: editedRecipe.servings, ingredients: finalIngredients },
                conversionId,
                userId: null,
                videoThumbnail,
            });
...
export default RecipeReviewCreate;